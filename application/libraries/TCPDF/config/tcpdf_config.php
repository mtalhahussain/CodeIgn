 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Sir Noor');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Talha Hussain');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE','Sir Noor Coaching Center');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Surjani Town Karachi - 0343-2034899");
 ...
 */
define('K_CELL_HEIGHT_RATIO', 1.44);
